...
must match real exits (0002), the error contract must hold (0003), CLI
tests must be framework-blind (0004), and the output contract must not
drift (0006). This ADR fixes how those obligations are verified, so
