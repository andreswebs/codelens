...
// exactly two columns, malformed JSON, or an unknown format. It is a data
// error (exit 65), consistent with the other mapping inputs the design classifies
// as data rather than usage errors. Callers wrap it with the offending detail
...
// lookup. Any malformed input yields ErrInvalidTeamMap (exit 65).
