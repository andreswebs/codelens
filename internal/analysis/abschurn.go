...
func absChurnDescriptor() Descriptor {
	return Descriptor{
		...
		RowSchema: []Column{
			...
			{Name: "added", Type: "int", Semantic: SemanticLoc, Desc: "lines added on the date"},
			{Name: "deleted", Type: "int", Semantic: SemanticLoc, Desc: "lines deleted on the date"},
			{Name: "commits", Type: "int", Semantic: SemanticCount, Desc: "number of distinct revisions on the date"},
		},
