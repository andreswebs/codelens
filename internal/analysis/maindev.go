...
func mainDevDescriptor() Descriptor {
	return Descriptor{
		...
		RowSchema: []Column{
			...
			{Name: "main_dev", Type: "string", Semantic: SemanticPerson, Desc: "author who added the most lines"},
			...
			{Name: "ownership", Type: "float", Semantic: SemanticRatio, Desc: "main developer's added lines over the total (2 significant digits)"},
		},
