...
func parseDescriptor() Descriptor {
	return Descriptor{
		...
		RowSchema: []Column{
			...
			{Name: "rev", Type: "string", Semantic: SemanticCommitID, Desc: "commit short hash"},
			{Name: "date", Type: "string", Semantic: SemanticDate, Desc: "commit date (YYYY-MM-dd)"},
			{Name: "author", Type: "string", Semantic: SemanticPerson, Desc: "commit author (may be a mapped team)"},
			{Name: "message", Type: "string", Semantic: SemanticText, Desc: "commit subject; \"-\" when absent"},
			{Name: "loc_added", Type: "int", Semantic: SemanticLoc, Desc: "lines added; omitted when numstat is absent"},
			{Name: "loc_deleted", Type: "int", Semantic: SemanticLoc, Desc: "lines deleted; omitted when numstat is absent"},
			{Name: "binary", Type: "bool", Semantic: SemanticFlag, Desc: "whether git recorded binary numstat; omitted when false"},
		},
