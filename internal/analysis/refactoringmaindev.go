...
func refMainDevDescriptor() Descriptor {
	return Descriptor{
		...
		RowSchema: []Column{
			...
			{Name: "main_dev", Type: "string", Semantic: SemanticPerson, Desc: "author who removed the most lines"},
			{Name: "removed", Type: "int", Semantic: SemanticLoc, Desc: "lines removed by the main developer"},
			{Name: "total_removed", Type: "int", Semantic: SemanticLoc, Desc: "total lines removed from the entity by all authors"},
			{Name: "ownership", Type: "float", Semantic: SemanticRatio, Desc: "main developer's removed lines over the total (2 significant digits)"},
		},
